...
macro_rules! trace {
    (str $s:expr) => {{
        ...
        $crate::kmsg::str_log($crate::kmsg::KeAttLvl::Trace, concat!("kernel::", concat!("kernel::", module_path!())), file!(), line!(), $s);
    }};
    ($($arg:tt)+) => {{
        #[cfg(not(feature = "lowlog"))]
        $crate::kmsg::log($crate::kmsg::KeAttLvl::Trace, concat!("kernel::", module_path!()), file!(), line!(), format_args!($($arg)+));
    }};
}
...
macro_rules! debug {
    (str $s:expr) => {{
        #[cfg(not(feature = "lowlog"))]
        $crate::kmsg::str_log($crate::kmsg::KeAttLvl::Debug, concat!("kernel::", module_path!()), file!(), line!(), $s);
    }};
    ($($arg:tt)+) => {{
        #[cfg(not(feature = "lowlog"))]
        $crate::kmsg::log($crate::kmsg::KeAttLvl::Debug, concat!("kernel::", module_path!()), file!(), line!(), format_args!($($arg)+));
    }};
}
...
macro_rules! info {
    (str $s:expr) => {{
        $crate::kmsg::str_log($crate::kmsg::KeAttLvl::Info, concat!("kernel::", module_path!()), file!(), line!(), $s);
    }};
    ($($arg:tt)+) => {{
        $crate::kmsg::log($crate::kmsg::KeAttLvl::Info, concat!("kernel::", module_path!()), file!(), line!(), format_args!($($arg)+));
    }};
}
...
macro_rules! warn {
    (str $s:expr) => {{
        $crate::kmsg::str_log($crate::kmsg::KeAttLvl::Warn, concat!("kernel::", module_path!()), file!(), line!(), $s);
    }};
    ($($arg:tt)+) => {{
        $crate::kmsg::log($crate::kmsg::KeAttLvl::Warn, concat!("kernel::", module_path!()), file!(), line!(), format_args!($($arg)+));
    }};
}
...
macro_rules! error {
    (str $s:expr) => {{
        $crate::kmsg::str_log($crate::kmsg::KeAttLvl::Error, concat!("kernel::", module_path!()), file!(), line!(), $s);
    }};
    ($($arg:tt)+) => {{
        $crate::kmsg::log($crate::kmsg::KeAttLvl::Error, concat!("kernel::", module_path!()), file!(), line!(), format_args!($($arg)+));
    }};
}
...
macro_rules! __panic_msg {
    (str $s:expr) => {{
        $crate::kmsg::str_log($crate::kmsg::KeAttLvl::Panic, concat!("kernel::", module_path!()), file!(), line!(), $s);
    }};
    ($($arg:tt)+) => {{
        $crate::kmsg::log($crate::kmsg::KeAttLvl::Panic, concat!("kernel::", module_path!()), file!(), line!(), format_args!($($arg)+));
    }};
}
